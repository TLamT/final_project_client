  ...
  const roleSkillTC = (value) => {
    switch (value) {
      ...
      case "optionB": // Detective
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-green-100 text-green-800 shadow">
            <strong>偵探技能（明察秋毫）</strong>:
            “偵探用放大鏡，解鎖每晚的‘八卦新聞’！哪邊好哪邊壞，等我一查便知！”
            每晚可以查看一名玩家的陣營（好人或壞人）。
          </div>
        );
        break;
      case "optionC": // Defender
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-yellow-100 text-yellow-800 shadow">
            ...
            “守護者守護！今晚幫你擋子彈，聽晚我換個人罩，畢竟這個城鎮不缺麻煩。”
            每晚保護一名玩家。
          </div>
        );
        break;
      case "optionD": // Medium
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-purple-100 text-purple-800 shadow">
            <strong>靈媒技能（通靈）</strong>:
            “靈媒的口號：‘死者之言，聲聲入耳。這是來自陰間的最新報告！’”
            每晚都能夠查看已死玩家之間的對話。
          </div>
        );
        break;
      case "optionE": // Cupid
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-pink-100 text-pink-800 shadow">
            <strong>丘比特技能（愛神祝福）</strong>:
            “愛神的箭矢一出，天雷勾地火。無論愛情還是毀滅，皆在箭矢之下！”
      ...
      case "optionF": // Sentinel
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-indigo-100 text-indigo-800 shadow">
            <strong>哨兵技能（窺間伺隙）</strong>:
            “哨兵：‘誰來了？都在我眼皮底下，做賊心虛的，全都一清二楚！’”
      ...
      case "optionH": // VampireHunter
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-red-100 text-red-800 shadow">
            <strong>吸血鬼獵人技能（百步穿楊）</strong>:
            “獵人專業剋星，讓我一劍封喉！吸血鬼見我都繞著走。”
      ...
      case "optionI": // Reaper
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-orange-100 text-orange-800 shadow">
            <strong>殺手技能（開膛破肚）</strong>:
            “開膛手的信條：‘刀在手，天下我有！下個夜晚，誰是倒霉蛋？’”
      ...
      case "optionK": // Scammer
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-blueGray-100 text-blueGray-800 shadow">
            <strong>欺詐師技能（完美偽裝）</strong>:
            “偽裝成好人？小菜一碟！我可是全鎮最會演戲的騙子！”
      ...
      case "optionL": // TwistedFate
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-rose-100 text-rose-800 shadow">
            <strong>賭徒技能（逆命）</strong>: “一賭成名”
            夜間可以賭一個人的具體身份，賭中對方出局；賭不中自己則會顯示身份比所有人。
          </div>
        );
        break;
      case "optionM": // Vampire
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-purple-100 text-purple-800 shadow">
            <strong>吸血鬼技能（嗜血成性）</strong>:
            “吸血鬼夜半出沒，吸血轉化，成為我忠誠的僕人！”
      ...
      case "optionN": // Conspirator
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-orange-100 text-orange-800 shadow">
            <strong>謀略家技能（爾虞我詐）</strong>:
            “陰謀算計？謀略家可不是等閒之輩，誰該走，我說了算！”
            想辦法操縱局勢，讓某位玩家被投票出局。
          </div>
        );
        break;
      ...
      case "optionP": // Reminiscence
        setDisplayRoleSkill(
          <div className="p-4 mb-4 border rounded-lg bg-blue-100 text-blue-800 shadow">
            <strong>追憶者技能（追憶）</strong>:
            “追憶者喚醒亡靈，不僅繼承其能力，還讓你們重新認識真正的我！”
